        ...
        <MainLayout>
            <div class="flex flex-col items-center justify-center flex-grow">
                <div class="flex flex-col rounded-lg shadow-lg bg-white p-6 w-[90%] min-w-[300px] md:w-[60%] md:min-w-[400px] mt-4 mb-4">
                    ...
                    <a href="/upload" class="w-full"><button class="mt-4 rounded bg-[#ff6004] shadow-md text-white text-center p-4 hover:shadow-sm hover:bg-[#df5200] w-full mr-5">Kép feltöltése</button></a>
                ...
                <Show when={data()} fallback={
                                                ...
                                                <p>Loading...</p>
                                                    ...
                                                    <div class="flex flex-col rounded-lg shadow-lg bg-white p-6 w-[90%] min-w-[300px] md:w-[60%] md:min-w-[400px] mt-4 mb-4">
                                                        ...
                                                        <img src={"http://localhost:8000/" + data().title} alt="Recommended Post" class="rounded-lg shadow-lg w-full h-auto mb-4" />
                                                    </div>
                                                </Show>
            </div>
        </MainLayout>
